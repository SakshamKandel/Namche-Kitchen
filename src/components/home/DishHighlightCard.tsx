...
import type { DishLike } from "@/components/menu/MenuItemCard";
...
export function DishHighlightCard({ item }: { item: DishLike }) {
  ...
  return (
    <article
      className="group flex w-64 shrink-0 flex-col overflow-hidden rounded-2xl border border-cream-200 bg-white shadow-subtle transition-shadow duration-200 hover:shadow-subtle"
